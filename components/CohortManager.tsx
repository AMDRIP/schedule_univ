        ...
        <div className="grid gap-6 xl:grid-cols-[420px_minmax(0,1fr)]">
          <section className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            ...
            <div className="mt-4 space-y-3">
              ...
              <Select label="Дисциплина" value={streamDraft.subjectId || ''} onChange={value => setStreamDraft(prev => ({ ...prev, subjectId: value }))} options={[{ value: '', label: 'Не задана' }, ...subjects.map(item => ({ value: item.id, label: item.name }))]} />
